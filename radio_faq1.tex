...
Aktualnie znak wywoławczy jeśli jest wolny to można sobie wybrać, kiedyś wydawano je po kolei. Prefiksu 3Z ani HF nie dostaniemy ze względu na to, że są one wydawane stacjom okolicznościowym. SR dla stacji kategorii 5 (automatycznych). Kiedyś istniało SO, dedykowane kategorii 3, ale teraz stan tego prefiksu jest niejasny.
