...
Zawody radiowe najczęściej polegają na tym, aby zawodnicy nawiązali jak najwiecej łączności najlepiej na jak najwiekszej odległości. Podczas zawodów na falach krótkich najczęściej osobno sa przynawane punkty za stacje lokalne, czyli z tego samego kontynentu a większa liczba punktów jest przyznawana za stacja DX, czyli zinnych kontynentów. Podczas zawodów UKF bardzo czesto liczy sie każdy kilometr łączności. Regulaminy zawodów czasami zawierają ciekawe zapisy utrudniające pracę,  które powodują, ze zawody są ciekawsze.  
